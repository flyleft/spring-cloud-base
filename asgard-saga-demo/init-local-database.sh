...
then
    curl http://nexus.choerodon.com.cn/repository/choerodon-release/io/choerodon/choerodon-tool-liquibase/0.8.0.RELEASE/choerodon-tool-liquibase-0.8.0.RELEASE.jar -L  -o choerodon_temp/choerodon-tool-liquibase.jar
fi
